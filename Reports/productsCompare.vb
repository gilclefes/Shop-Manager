...
Public Class productsCompare
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shop_Manager.productsCompare.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedproductsCompare
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As productsCompare = New productsCompare()
        rpt.Site = Me.Site
        Return rpt
    End Function
