...
Public Class productsReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Shop_Manager.productsReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedproductsReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As productsReports = New productsReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
