...
Public Class salesReportsCompare
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "salesReportsCompare.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsalesReportsCompare
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As salesReportsCompare = New salesReportsCompare
        rpt.Site = Me.Site
        Return rpt
    End Function
